...
class HttpResponseParser {
  ...
  /// Returns an empty list on missing or malformed payload.
  static List<dynamic> parseList(http.Response response, {String label = 'request'}) {
  ...
  static Map<String, dynamic> parseObject(http.Response response, {String label = 'request'}) {
    _assertSuccess(response, label);
    final data = jsonDecode(response.body) as Map<String, dynamic>;
  ...
  static bool parseWriteResult(http.Response response, {String label = 'request'}) {
    _assertSuccess(response, label);
    final outer = jsonDecode(response.body) as Map<String, dynamic>;
    final inner = jsonDecode(outer['value'] as String? ?? '{}') as Map<String, dynamic>;
